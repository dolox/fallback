...
b.callback;this.libraries=a;this.initialize()},ready:function(a){this.ready_functions[this.ready_functions.length]=a},ready_invocation:function(){var a;if(this.ready_functions)for(a in this.ready_functions)this.ready_functions[a](this.loaded,this.broken)},spawn:function(a,b,c){var d=document.createElement("script");d.src=b;d.onload=function(){fallback.success(a,c)};d.onerror=function(){fallback.error(a,c)};this.head.appendChild(d)},success:function(a,b){this.loaded[a]=this.libraries[a][b];this.loaded_count++;
