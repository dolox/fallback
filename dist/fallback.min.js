...
b.apply(null,a.module.R(c)):b};a.module.u=function(b){a.c(a.module.f[b])&&(b=a.module.f[b]);return b};a.module.R=function(b){var c=[];if(!b.length)return c;a.b(b,function(b){c.push(a.module.i(b))});return c};a.module.urls=function(b,c){var e=a.module.base(b),d="."+b,f=[];a.b(c,function(c){"img"!==b&&c.substr(-d.length)!==d&&(c+=d);if(e){var h=!1;a.b(a.module.urls.O,function(a){if(c.substr(0,a.length)===a)return h=!0,!1});h||(c=e+c)}f.push(c)});return f};a.module.urls.O=["/","data:","http://","https://"];
